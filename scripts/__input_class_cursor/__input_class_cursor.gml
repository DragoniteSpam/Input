function __input_class_cursor() constructor
{
    ...
    static __tick = function()
    {
        ...
        if (global.__input_cursor_verbs_valid && (!global.__input_pointer_moved || !_can_use_mouse) && (__player.__rebind_state <= 0))
        {
            ...
            if (_gamepad_index >= 0) _motion = global.__input_gamepads[_gamepad_index].__motion;
            ...
            {                
                ...
                if (_gyro_value_x != undefined) __x += round((_gyro_value_x * _dts * window_get_width()  * __player.__gyro_sensitivity_x * 10)) / 10;
                if (_gyro_value_y != undefined) __y += round((_gyro_value_y * _dts * window_get_height() * __player.__gyro_sensitivity_y * 10)) / 10;
            }
