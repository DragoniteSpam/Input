...
function __input_initialize()
{
    ...
    //Keyword handling instruction struct
    global.__input_gamepad_keyword_config = {};
    __input_gamepad_keyword_config_set(gp_none,        { buttons: true,   axes: true,   negative: true  });
    __input_gamepad_keyword_config_set(gp_any,         { buttons: true,   axes: true,   negative: false });
    __input_gamepad_keyword_config_set(gp_axis_none,   { buttons: false,  axes: true,   negative: true  });
    __input_gamepad_keyword_config_set(gp_axis_any,    { buttons: false,  axes: true,   negative: false });
    __input_gamepad_keyword_config_set(gp_button_none, { buttons: true,   axes: false,  negative: true  });
    __input_gamepad_keyword_config_set(gp_button_any,  { buttons: true,   axes: false,  negative: false });
